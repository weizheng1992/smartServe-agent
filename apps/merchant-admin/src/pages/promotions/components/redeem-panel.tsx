  ...
  return (
    <div className="rounded-xl border border-blue-200 bg-blue-50/60 p-4">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
        <input className="w-64 rounded-lg border border-zinc-300 px-3 py-2" placeholder="订单号,如 AURORA-ORD-2026-9091" value={orderId} onChange={(e) => setOrderId(e.target.value)} />
        <Button size="sm" disabled={!orderId} onClick={() => void submitRedeem()}>确认核销</Button>

...
import { Avatar, AvatarFallback, Button, Loader2, LogOut, MessageSquare, Plus, Trash2 } from 'ui';
...
interface LeftSidebarProps {
  ...
  handleDeleteThread: (e: any, id: string) => Promise<void>;
  handleMerchantSwitch: (merchantId: string) => Promise<void>;
  handleLogout: () => void;
  formatFriendlyDate: (dateStr: any) => string;
}

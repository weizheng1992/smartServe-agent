...
export const threads = pgTable(
  ...
  (table) => ({
    threadsBizStatusIdx: index("threads_biz_status_idx").on(
      table.businessId,
      table.status,
    ),
...
export const messages = pgTable(
  ...
  (table) => ({
    ...
    messagesBizThreadIdx: index("messages_biz_thread_idx").on(
      table.businessId,
      table.threadId,
    ),
  }),
...
export const intentExemplars = pgTable(
  ...
  (table) => ({
    exemplarBizIdx: index("intent_exemplars_biz_idx").on(
      table.businessId,
      table.intentName,
    ),
  }),

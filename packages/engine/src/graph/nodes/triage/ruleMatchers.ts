...
const GREETING_REGEX = /^(你好|您好|哈喽|哈罗|hello|hi|hey|哈拉|早上好|下午好|晚上好)$/i;

const EXIT_REGEX =
  /^(再见|退出|bye|exit|quit|再见啦|拜拜|不聊了|好的，我的问题已经解决了，谢谢|我的问题解决了|问题解决了|解决了|谢谢|谢谢你|多谢)$/i;

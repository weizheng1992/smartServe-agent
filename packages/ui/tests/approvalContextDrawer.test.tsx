...
import {
  ...
  type ApprovalContextDetail,
} from "../src/components/approval/ApprovalContextDrawer";
    ...
    const mockDetail: ApprovalContextDetail = {
      ...
      orders: [
        ...
        },
        {
          ...
          items: [
            { productName: "Nike 运动速干 T 恤", price: 399.0, quantity: 1 },
          ],
        },
      ],
      messages: [
        ...
        },
        {
          ...
          role: "assistant",
          content:
            "您好！很抱歉给您带来不好的体验，请提供您的订单号或需要退款的诉求。",
          timestamp: "10:00:03",
        },
        {
          id: "msg_3",

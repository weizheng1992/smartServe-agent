...
export const OrderPickerCard: React.FC<OrderPickerCardProps> = ({
  data,
  onAction,
}) => {
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-1.5 text-xs font-semibold text-indigo-200">
                ...
                <span>
                  {data.title || `为您查询到 ${totalCount} 笔订单记录`}
                </span>
              </div>
          ...
          {orders.slice(0, 2).map((ord, idx) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono font-medium text-slate-200 group-hover:text-indigo-300">
                  {ord.orderId}
                </span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <DialogContent className="max-w-xl max-h-[85vh] bg-slate-900 border-slate-800 text-slate-100 p-0 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3">
            {orders.map((ord, idx) => {
              ...
              const isShipped =
                ord.status === "SHIPPED" || ord.status === "已发货";

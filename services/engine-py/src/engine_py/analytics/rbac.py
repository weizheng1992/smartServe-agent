...
ROLE_METRIC_PERMISSIONS: dict[str, list[str] | None] = {
    ...
    "admin": None,  # 管理员同老板全量
    "sales_viewer": ["gmv", "gmv_trend", "volume_trend", "order_overview", "volume", "review_bad", "review_good", "refund_rate", "session_volume", "ai_resolution_rate", "aov", "order_count", "zero_sales", "category_gmv_top", "customer_spend_top"],
    "warehouse_operator": ["volume", "stock_risk", "refund_rate", "session_volume", "zero_sales"],
}
